...
import 'package:adv2023/day6.dart' as day6;


import 'package:adv2023/day9.dart' as day9;

import 'package:adv2023/day11.dart' as day11;
...
Future solveProblem (String? problemNumber, List<String> additionalArgs) async {
  ...
  switch (problemNumber){
    ...
    case "10":
    case "11":
          result = await day6.solvePart1(additionalArgs);
    case "12":
          result = await day6.solvePart2(additionalArgs);
    case "13":
    case "14":
    case "15":
    case "16":
    case "17":
          result = await day9.solvePart1(additionalArgs);
    case "18":
          result = await day9.solvePart2(additionalArgs);
    case "19":
    case "20":
    case "21":
          result = await day11.solvePart1(additionalArgs);
    case "22":
          result = await day11.solvePart2(additionalArgs);
    case "23":
    case "24":
    case "25":
    case "26":
